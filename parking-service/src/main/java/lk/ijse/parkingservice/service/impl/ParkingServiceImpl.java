...
import lk.ijse.parkingservice.exception.BadRequestException;
import lk.ijse.parkingservice.exception.ParkingNotFoundException;
...
public class ParkingServiceImpl implements ParkingService {
    ...
    private void updateParkingStatus(Parking parking) {
        if (parking.getStatus() == ParkingStatus.CLOSED) return;
        parking.setStatus(parking.getAvailableSlots() == 0 ? ParkingStatus.FULL : ParkingStatus.AVAILABLE);
    }
